...
def generate_launch_description():
    ...
    launch_args = [
        ...
        DeclareLaunchArgument('robot_entity_name', default_value='rml_63_arm_robot'),
        ...
        DeclareLaunchArgument('initial_y', default_value='-2.0'),
        DeclareLaunchArgument('initial_z', default_value='1.03'),
