...
def generate_launch_description():
    robot_base_set = False
    camera_set = True
    robot_entity_name='rml_63_arm_robot'
    init_pose=['2.0','-2.0','1.03','0','0','3.14159']
    launch_args = launch_utils.declare_common_launch_arguments(
        robot_base_set, camera_set, robot_entity_name, init_pose)
